...
namespace CommonUtils
{
	...
	Object* BuildSphereObject(  //for big ball
	...
	//Generates a default Sphere object with the parameters specified.
	Object* BuildSphereObject1(  //for small ball
		const std::string& name,
		const Vector3& pos,
		float radius,
		bool physics_enabled = false,
	...
	Object* BuildSphereObject2(  //for small shootball
		const std::string& name,
		const Vector3& pos,
		float radius,
		bool physics_enabled = false,
	...
	Object* BuildSphereObject3(  //for balltower
		const std::string& name,
		const Vector3& pos,
		float radius,
		bool physics_enabled = false,
