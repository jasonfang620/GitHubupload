...
Object* CommonUtils::BuildSphereObject( //for big ball
...
Object* CommonUtils::BuildSphereObject1(  //for small ball
	const std::string& name,
	const Vector3& pos,
	float radius,
	bool physics_enabled,
	...
	const Vector4& color)
{
	...
	pSphere->SetMesh(CommonMeshes::Sphere(), false);
	pSphere->SetTexture(CommonMeshes::CheckerboardTexball(), false);
	pSphere->SetLocalTransform(Matrix4::Scale(Vector3(radius, radius, radius)));
	pSphere->SetColour(color);
	pSphere->SetBoundingRadius(radius);
...
Object* CommonUtils::BuildSphereObject2(  //for small shootball
	const std::string& name,
	const Vector3& pos,
	float radius,
	bool physics_enabled,
	...
	const Vector4& color)
{
	...
	pSphere->SetMesh(CommonMeshes::Sphere(), false);
	pSphere->SetTexture(CommonMeshes::CheckerboardTexballshoot(), false);
	pSphere->SetLocalTransform(Matrix4::Scale(Vector3(radius, radius, radius)));
	pSphere->SetColour(color);
	pSphere->SetBoundingRadius(radius);
...
Object* CommonUtils::BuildSphereObject3(	//for balltower
	const std::string& name,
	const Vector3& pos,
	float radius,
	bool physics_enabled,
	...
	const Vector4& color)
{
	...
	pSphere->SetMesh(CommonMeshes::Sphere(), false);
	pSphere->SetTexture(CommonMeshes::CheckerboardTex1(), false);
	pSphere->SetLocalTransform(Matrix4::Scale(Vector3(radius, radius, radius)));
	pSphere->SetColour(color);
	pSphere->SetBoundingRadius(radius);
	...
	const Vector4& color)
{
	...
	pCuboid->SetTexture(CommonMeshes::CheckerboardTex1(), false);
...
Object* CommonUtils::BuildCuboidObjectGroud(
	const std::string& name,
	const Vector3& pos,
	const Vector3& halfdims,
	bool physics_enabled,
	...
	const Vector4& color)
{
	...
	pCuboid->SetMesh(CommonMeshes::Cube(), false);
	pCuboid->SetTexture(CommonMeshes::Checkergroud(), false);
	pCuboid->SetLocalTransform(Matrix4::Scale(halfdims));
	pCuboid->SetColour(color);
	pCuboid->SetBoundingRadius(halfdims.Length());
...
Object* CommonUtils::BuildPlantObject(
	const std::string& name,
	const Vector3& pos,
	const Vector3& halfdims,
	bool physics_enabled,
	...
	const Vector4& color)
{
	...
	pCuboid->SetLocalTransform(Matrix4::Scale(halfdims));
	pCuboid->SetLocalTransform(Matrix4::Translation(Vector3(-1.0f * halfdims.x  , -1.0f * halfdims.y  , halfdims.z)
	...
	else
	{
		...
		{
			CollisionShape* pColshape = new CuboidCollisionShape(halfdims/**0.5f*/);
